      ...
      isExistFun(){
        this.$http({
          ...
          if(response.register_status === 'register'){
            this.routerPush('registertwo', {telnum: this.telVal, inviteCode: this.$route.query.inviteCode,})
          }else if(response.register_status === 'login'){
            this.routerPush('login', {tel: this.telVal, inviteCode: this.$route.query.inviteCode,})
            return
          }else{
            // forbid
            this.showAlert = true
