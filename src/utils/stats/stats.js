 ...
 * 2018-03-21
 */
function  cssTextFun (opacity, top=0){
  return `
    position:fixed;
    top:${top};
    left:0;
...
let Stats = function () {
  ...
  container.style.cssText = container.style.cssText = cssTextFun('0.1')
  container.className = 'hover'  
  container.addEventListener('touchstart', ()=>{
    console.log('touchstart');
    container.style.cssText = cssTextFun('0.9', '50px')
  })
  container.addEventListener('touchend', ()=>{
    console.log('touchend');
    clearTimeout(timer)
    timer = setTimeout(() => {
      container.style.cssText = cssTextFun('0.1', '50px')
    }, 3000);
