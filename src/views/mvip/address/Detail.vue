<template>
  <div ref="root">
    ...
    <jinr-cell-group class="van-address-edit-detail__suggest-list" v-if="showSearchList">
      <jinr-cell
        v-for="express in searchResult"
        :key="express.name + express.address"
        class="van-address-edit-detail__suggest-item"
        @click="onSuggestSelect(express)">
        <!-- <jinr-icon name="location" class="van-address-edit-detail__location" /> -->
...
import isAndroid from 'utils/is-andriod';
