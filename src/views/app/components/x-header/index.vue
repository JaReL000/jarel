  ...
  <div class="vux-header">
    ...
    <div class="vux-header-right">
      ...
      <a 
        ...
        :class="{'vux-header-url-d': rightOptions.textCopy === '服务中心'}"        
...
.vux-header .vux-header-left .left-arrow {
  ...
  background: url('./title_arrow.png') no-repeat 30px center;
...
.vux-header .vux-header-right .vux-header-more {
  ...
  background:  url('./title_share.png') no-repeat 30px center; 
