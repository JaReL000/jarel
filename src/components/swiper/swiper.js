...
class Swiper {
  constructor (options) {
    this._default = {
      container: '.jinr-swiper',
      item: '.jinr-swiper-item',
      direction: 'vertical', //方向
      activeClass: 'active',
      threshold: 150, //150 //当滑动超过这个距离时才滑动
      duration: 300, //切换动画时间
      auto: false,
      loop: false, //是否循环
      interval: 3000, //轮播停留时长
      height: 'auto',
      minMovingDistance: 0
    }
    ...
    this.$container = this._options.container.querySelector('.jinr-swiper')
