  ...
  <div class="giftDetail">
    <section class="giftDetail-wrap">
      ...
      <div class="giftDetail-bg5">
        <div>
          <img :src="item" v-for="( item,index ) in detailPhoto" :key="index">
        </div>
      </div>
...
export default {
  ...
  created () {
    ...
    let $combinationId = sessionStorage.getItem( 'combination_id' )
