...
<script type="text/ecmascript-6">
  ...
  const TITLE_HEIGHT = 50*2
  const SUBTITLE_HEIGHT = 40*2
  ...
  export default {
    ...
    watch: {
      ...
      diff(newVal) {
        ...
        this.$refs.fixed.style.transform = `translate3d(0,${fixedTop}*2px,0)`
      },
      scrollY(newY) {
